  ...
  return (
    <section className="py-20 lg:py-28">
      <div className="max-w-7xl mx-auto container-px">
        <SectionHeader eyebrow="Testimonials" title="Trusted by enterprise teams" />
        <div className="mt-12 grid md:grid-cols-2 gap-5">
          {testimonials.map((t, i) => (
            <figure
              key={i}
              className="p-7 rounded-2xl bg-card border border-border/70 relative overflow-hidden"
            >
