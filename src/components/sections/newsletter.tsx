      ...
      <div className="max-w-7xl mx-auto container-px grid gap-8 lg:grid-cols-[1fr_520px] lg:items-center">
        ...
        <form className="flex flex-col gap-3 sm:flex-row" onSubmit={onSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="h-12 px-5 rounded-xl gradient-primary text-primary-foreground text-sm font-medium inline-flex items-center justify-center gap-1.5 hover:opacity-90 disabled:opacity-70"
          >
            {loading ? (
              <>
                Subscribing <Spinner size="xs" />
              </>
            ) : (
              <>
